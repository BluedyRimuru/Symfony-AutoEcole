...
class VehiculeController extends AbstractController
{
    ...
    {
        return $this->render('crud/vehicule/index.html.twig', [
    ...
    public function new(Request $request, VehiculeRepository $vehiculeRepository): Response
    {
        ...
        return $this->renderForm('crud/vehicule/new.html.twig', [
            'vehicule' => $vehicule,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('crud/vehicule/show.html.twig', [
            'vehicule' => $vehicule,
        ]);
    }
    ...
    public function edit(Request $request, Vehicule $vehicule, VehiculeRepository $vehiculeRepository): Response
    {
        ...
        return $this->renderForm('crud/vehicule/edit.html.twig', [
            'vehicule' => $vehicule,
            'form' => $form,
        ]);
    }
