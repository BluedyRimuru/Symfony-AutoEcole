...
class LicenceController extends AbstractController
{
    ...
    {
        return $this->render('crud/licence/index.html.twig', [
            'licences' => $licenceRepository->findAll(),
        ]);
    }

    #[Route('/new', name: 'app_licence_new', methods: ['GET', 'POST'])]
    public function new(Request $request, LicenceRepository $licenceRepository): Response
    {
        $licence = new Licence();
        ...
        return $this->renderForm('crud/licence/new.html.twig', [
            'licence' => $licence,
            'form' => $form,
        ]);
    }
    ...
    {
        return $this->render('crud/licence/show.html.twig', [
            'licence' => $licence,
        ]);
    }
    ...
    public function edit(Request $request, Licence $licence, LicenceRepository $licenceRepository): Response
    {
        ...
        return $this->renderForm('crud/licence/edit.html.twig', [
            'licence' => $licence,
            'form' => $form,
        ]);
    }
